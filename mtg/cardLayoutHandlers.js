...
function generateBase(scryfallObject) {
    let base = {
        ...
        usd: ('usd' in scryfallObject) ? scryfallObject.prices.usd : 'N/A',
        usdFoil: ('usd_foil' in scryfallObject.prices) ? scryfallObject.prices.usd_foil : 'N/A',
        eur: ('eur' in scryfallObject) ? scryfallObject.prices.eur : 'N/A',
        tix: ('tix' in scryfallObject) ? scryfallObject.prices.tix : 'N/A',
